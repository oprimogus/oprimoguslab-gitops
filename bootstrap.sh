...
NAMESPACE="argocd"
ARGOCD_MANIFEST_INSTALL_URL="https://raw.githubusercontent.com/argoproj/argo-cd/stable/manifests/install.yaml"
ARGOCD_PATH="infrastructure/argocd"
ROOT_APP_PATH="k8s/argocd/bootstrap/root-app.yaml"

echo "Creating namespace: $NAMESPACE"
kubectl create namespace $NAMESPACE || echo "Namespace $NAMESPACE already exists"

echo "Installing ArgoCD..."
kubectl apply -n $NAMESPACE -f $ARGOCD_MANIFEST_INSTALL_URL
